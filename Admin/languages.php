...
<html>
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="home.php">Admin Home</a>  > Languages</h6>
    <h1 class="nametitle">Languages</h1>
    <h3 class="subtitle">Edit details of LaTCh languages here.</h3>
    <?php
      if(isset($_SESSION['signup'])){
          if($_SESSION['signup'] == 1){
            echo "<h3 style='color: green;' class='subtitle'>A new language has just been added.</h3>";
            $_SESSION['signup'] = 0;
          }
          if($_SESSION['signup'] == 2){
            echo "<h3 style='color: green;' class='subtitle'>Language deleted.</h3>";
            $_SESSION['signup'] = 0;
          }
          if($_SESSION['signup'] == 3){
            echo "<h3 style='color: green;' class='subtitle'>Language updated.</h3>";
            $_SESSION['signup'] = 0;
          }
        }
    ?>
    ...
    ?>
    <br>
    <h3 class="subtitle">Add a new language [<a href="newLanguageForm.php">+</a>]</h3>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='timeline'>
                    <div class='item'>
                      ...
                      <h4 class='subtitle'>Name: " . $row['lName'] . "</h4>
                      <h4 class='subtitle'>Description: " . $row['description'] . "</h4>
                      <h4 class='subtitle'><a href='editLanguageForm.php?id=" . $row['id'] . "'>Edit</a> | <a class='confirm' href='deleteLanguage.php?id= " . $row['id'] . " '>Delete</a></h4>
  ...
  ?>
    ...
    <script>
      ...
      var confirmIt = function (e) {
        if (!confirm('Are you sure you want to delete this language?  You cannot undo this action.')) e.preventDefault();};

...
<html>
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="home.php">Admin Home</a> > <a id="breadcrumbs" href="users.php">Users</a> > Edit User</h6>
    <?php
      echo "<h1 class='nametitle'>Edit <i>USER" . $user_no . "</i></h1>";
    ?>
    <h3 class="subtitle"><a href="users.php"> < Back to Users </a></h3>
    <br>
    <!-- This form was copied and modified from https://www.w3schools.com/howto/howto_css_signup_form.asp [Last accessed 21/12/2017]. -->
    <?php
        echo "<form method='post' action='editUser.php?id=" . $user_no . "'>";
    ?>
      <div class="container">
        <?php
          $sql = "SELECT * FROM users WHERE id = $user_no";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              <input type='text' placeholder='" . $row['firstName'] . "' name='fname'>

              <label><b>Surname</b></label>
              <input type='text' placeholder='" . $row['surname'] . "' name='sname'>" .

              "<label><b>Email Address</b></label>
               <input type='text' placeholder='" . $row['email'] . "' name='eml'>" .

               "<label><b>Change Password</b></label>
               <input type='password' id='password' placeholder='' name='psw'>" .

               "<label><b>Confirm new Password</b></label>
               <input type='password' id='confirm_password' placeholder='' name='psw-repeat'>";
            }
          } else {
              echo "\nNo facts available...";
          }

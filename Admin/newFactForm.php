...
<html>
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="home.php">Admin Home</a> > <a id="breadcrumbs" href="facts.php">Facts</a> > New Fact</h6>
    <h1 class="nametitle">Add a new Fact of the Day</h1>
    <h3 class="subtitle">Add a new 'Fact of the day', along with it's source.</h3>
    <br>
    <!-- This form was copied and modified from https://www.w3schools.com/howto/howto_css_signup_form.asp [Last accessed 21/12/2017]. -->
    <form method="post" action="newFact.php">
      <div class="container">
        <?php
          echo "<label><b>Fact (Please include quotes)</b></label>
          <input type='text' placeholder='\"New Fact\"' name='fct' required>

          <label><b>Source URL</b></label>
          <input type='text' placeholder='Source' name='src' required>";

<?php
    ...
    else
    {
      ...
      $sql1 = $conn->prepare("UPDATE admin SET firstName = ? WHERE id = ?;");
    ...
    else
    {
      ...
      // prepare, bind and execute
      $sql2 = $conn->prepare("UPDATE admin SET surname = ? WHERE id = ?;");
    ...
    else
    {
      $email = $_POST['eml'];
      // prepare, bind and execute
      $sql3 = $conn->prepare("UPDATE admin SET email = ? WHERE id = ?;");
    ...
    else
    {
      ...
      // prepare, bind and execute
      $sql4 = $conn->prepare("UPDATE admin SET password = ? WHERE id = ?;");
    ...
    echo "<a href='../Admin/home.php'>Return to admin home</a>";

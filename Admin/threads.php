...
<html>
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="home.php">Admin Home</a>  > Threads</h6>
    <h1 class="nametitle">Discussion Board - all threads</h1>
    <?php
      if(isset($_SESSION['signup'])){
          if($_SESSION['signup'] == 1){
            echo "<h3 style='color: green;' class='subtitle'>A new thread has just been added.</h3>";
            $_SESSION['signup'] = 0;
          }
          if($_SESSION['signup'] == 2){
            echo "<h3 style='color: green;' class='subtitle'>Thread deleted.</h3>";
            $_SESSION['signup'] = 0;
          }
        }
    ?>
    ...
    <br>
    <h3 class="subtitle">You can remove unwanted discussion threads here.</h3>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div class='timeline'>
                    <div class='item'>
                      ...
                      <h3 class='subtitle'>" . $row['title'] . "</h3>
                      <h4 class='subtitle'>OP: ";
                      if($row['op'] == NULL){
                        echo "<i>Anonymous</i></h4>";
                      }
                      else
                      {
                        echo "<i>USER" . $row['op'] . "</i></h4>";
                      }
                      echo "<h4 class='subtitle'><a class='confirm' href='deleteThread.php?id=" . $row["id"] . "'>Delete</a></h4>

<!-- SUPPORT. Here, a user can gain support if they have trouble with the website. -->
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="index.php">Home</a> > Support</h6>
    <h1 class="nametitle">Support</h1>
    <h3 class="subtitle">If you are having any problems with the LaTCh system, please contact the LaTCh administrator, Ronan Smith via email: rs6@hw.ac.uk.</h3>
    <h3 class="subtitle">If you would like to leave feedback, please do so at the <a href="feedback.php">Feedback</a> page.</h3>
    <br>

...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified FlaskScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > Flask</h6>
    <h1 class="nametitle">Flask</h1>
    ...
    <div class="timeline">
      <div class="item">
        ...
        <div align="left" class="para">
          Flask is a Python micro framework for web development, based on the Werkzeug toolkit and Jinja2 template engine.
          It is called 'micro' because it has minimal features, however, it allows third-party libraries to be added to it to
          make it seem as if these features were being done by Flask itself.  This framework is used in a number of large web
          applications, including Pinterest and LinkedIn.
        </div>
        ...
        <div align="center" class="para">
          Flask is minimalistic, so it only has a small number of features for you to learn.  This makes it fairly easy to get
          started with.
        </div>

        <br>
        <div align="center">
          <a href="http://flask.pocoo.org/docs/0.12/tutorial/" target="_blank"><button>Get started with Flask here!</button></a>
        </div>
        <br>
      </div>
    </div>

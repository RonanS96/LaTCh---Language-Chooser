...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified OCAMLScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > OCAML</h6>
    <h1 class="nametitle">OCAML</h1>
    <h3 class="subtitle"><img src='../img/language/OCAML.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">Objective CAML. A member of the ML language family.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        <h3 class="subtitle"><b>Overview</b></h3>
        <div align="left" class="para">
          OCAML is one of many languages in the ML (Meta-Language) family.  It is a functional programming language that also has
          object-oriented features too.  The language first appeared in 1996, but has still been getting maintained to this day,
          by the French Institure for Research in Computer Science and Automation (INRIA).
          OCAML's toolset includes features such as an interactive top-level interpreter, a bytecode compiler and a reversible debugger.
        </div>
        ...
        <div align="center" class="para">
          OCAML is not really suitable for complete beginners, but maybe one to keep an eye on for later.
        </div>
        <br>
        <div align="center">
          <a href="https://ocaml.org/" target="_blank"><button>Find out more about OCAML here!</button></a>
        </div>
        <br>
      </div>
    </div>

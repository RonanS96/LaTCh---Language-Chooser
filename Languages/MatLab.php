...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified MatLabScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > MatLab</h6>
    <h1 class="nametitle">MatLab</h1>
    <h3 class="subtitle"><img src='../img/language/MatLab.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">A multi-paradigm numerical computing environment.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        <h3 class="subtitle"><b>Overview</b></h3>
        <div align="left" class="para">
          MatLab (Matrix Labratory) is not a programming language, but instead it is a multi-paradigm numerical computing environment.
          It was developed by "MathWorks", and was first released in 1984.  MatLab is popular - with around 1 million users currently in
          academia and industry.  This environment allows you to work with variables, structures, functions, classes and objects.
          It is also commonly used in data science for processing and manipulating large amounts of data.  It was wwritten using MATLAB
          scriping language, C++, C#, C, Java, Python and others, and can be run on Windows, macOS and Linux.
        </div>
        ...
        <div align="center" class="para">
          MatLab is good for beginners as it has a friendly graphical-user-interface and doesn't really require any programming knowledge.
          That's why it gets a 9/10.
        </div>

        <br>
        <div align="center">
          <a href="https://uk.mathworks.com/products/matlab.html" target="_blank"><button>Learn more about MatLab here!</button></a>
        </div>
        <br>
      </div>
    </div>

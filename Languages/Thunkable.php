...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified ThunkableScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > Thunkable</h6>
    <h1 class="nametitle">Thunkable</h1>
    <h3 class="subtitle"><img src='../img/language/Thunkable.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">An open source web application which allows you to create Android and iOS mobile apps using block programming.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        <h3 class="subtitle"><b>Overview</b></h3>
        <div align="left" class="para">
          Thunkable is not a programming language itself, but it is a web application that allows you to abstract over programming languages, using coloured blocks.
          It allows you to quickly build iOS and Android apps and carry out 'Live Tests' on your smartphone during development.  All you need to use Thunkable is
          a Google account and a creative attitude.
        </div>
        ...
        <div align="center" class="para">
          We have given Thunkable 10/10 - it is completely user friendly.  Thunkable allows you to build simple to complex apps using very simple implementation
          techniques - block programming and drag-and-drop for the user interface - meaning it is easy to pick up and it is easy to get apps working quickly.
          Furthermore, this type of programming allows you to learn many programmming fundamentals without having to deal with any source code.
        </div>
        <h3 class="subtitle"><b>Average Salary</b></h3>
        <h3 class="subtitle">$115,271 (USA)</h3>
        <div align="center" class="para">
          This figure is for iOS mobile app developers...  Of course there is a large gap between beginners programming on Thunkable and industrial programmers
        ...
        <br>
        <div align="center">
          <a href="https://thunkable.com/#/" target="_blank"><button>Get started with Thunkable here!</button></a>
        </div>
        <br>
      </div>
    </div>

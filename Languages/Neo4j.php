...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified Neo4jScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > Neo4j</h6>
    <h1 class="nametitle">Neo4j</h1>
    <h3 class="subtitle"><img src='../img/language/Neo4j.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">A graph-store database management system, written in Java.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        <h3 class="subtitle"><b>Overview</b></h3>
        <div align="left" class="para">
          Neo4j is the most popular graph database management system.  It is ACID compliant and moves away from the relational SQL model
          of database architecture.  In Neo4j, everything is stored in either the form of an edge, a node, or an attribute.
        </div>
        ...
        <div align="center" class="para">
          It takes a bit of getting used to if you haven't used graph databases before, but Neo4j is fairly friendly to programmers and non-programmers alike.
        </div>
        <h3 class="subtitle"><b>Average Salary</b></h3>
        <h3 class="subtitle">$85,000</h3>
        <div align="center" class="para">
          This figure is for a software engineer working with Neo4j.
          [<a target="_blank" href="https://www.payscale.com/research/US/Skill=Neo4j/Salary">Source</a>]
        </div>
        <br>
        <div align="center">
          <a href="https://neo4j.com/" target="_blank"><button>Learn more about Neo4j here!</button></a>
        </div>
        <br>
      </div>
    </div>

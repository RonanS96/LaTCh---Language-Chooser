...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified RubyScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > Ruby</h6>
    <h1 class="nametitle">Ruby</h1>
    <h3 class="subtitle"><img src='../img/language/Ruby.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">A dynamic, general-purpose programming language that first appeared in 1995.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        ...
        <br>
        <div align="center">
          <a href="http://www.ruby-lang.org/en/" target="_blank"><button>Learn more about Ruby here!</button></a>
        </div>
        <br>
      </div>
    </div>

...
<html>
  <head>
    ...
    <!-- Bootstrap links -->
      ...
      <!-- Latest compiled and minified Event-MLScript -->
  ...
  <body>
    ...
    <br>
    <br>
    <h6><a id="breadcrumbs" href="../index.php">Home</a> > <a id="breadcrumbs" href="all.php">Languages</a> > Event-ML</h6>
    <h1 class="nametitle">Event-ML</h1>
    <h3 class="subtitle"><img src='../img/language/Event-ML.png' height='200' width='200'></img></h3>
    <h3 class="subtitle">An event-driven version of the classic functional language, ML.</h3>
    <br>
    <div class="timeline">
      <div class="item">
        <h3 class="subtitle"><b>Overview</b></h3>
        <div align="left" class="para">
          A member of the ML family, which is closely related to the original ML language, Event-ML is a language that carries
          out functions based on the occurence of events.
        </div>
        ...
        <div align="center" class="para">
          Event-ML is a functional programming language, which is very different to other, more regular paradigms.
          Languages like this one come with a bit of a learning curve, but are of course still useful to learn.
        </div>
        <br>
        <div align="center">
          <a href="http://www.nuprl.org/software/" target="_blank"><button>Learn more about Event-ML here!</button></a>
        </div>
        <br>
      </div>
    </div>
